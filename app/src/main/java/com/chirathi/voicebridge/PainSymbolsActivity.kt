...
class PainSymbolsActivity : AppCompatActivity() {
    ...
    private fun setupIconClickListeners() {
        ...
        val iconData = mapOf(
            R.id.imgHeadache to Pair(R.drawable.headache, "I have a headache"),
            R.id.imgToothache to Pair(R.drawable.toothache, "I have a toothache"),
            R.id.imgstomachAche to Pair(R.drawable.stomach_ache, "I have a stomach ache")
        )
