        ...
        when (currentSongTitle) {
            ...
            "Twinkle Twinkle Little Star" -> {
                ...
                currentKeywords = listOf(
                    ...
                    Keyword("star", R.drawable.rhy_song1_star, 57000, 59000),
                    Keyword("traveller", R.drawable.rhy_song1_traveller, 67000, 69000),
                    Keyword("star", R.drawable.rhy_song1_star, 85000, 86000),
                    ...
                    Keyword("sun", R.drawable.rhy_song1_sun, 112000, 114000),
                    Keyword("star", R.drawable.rhy_song1_star, 116000, 118000),
                )
            }
            "Jack and Jill" -> {
                currentLyrics = listOf(
